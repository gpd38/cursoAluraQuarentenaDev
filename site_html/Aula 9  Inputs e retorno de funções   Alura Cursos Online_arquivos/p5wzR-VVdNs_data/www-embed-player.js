...
b.call(void 0,g,h,a)&&(d[e++]=g)}return d},Pa=Array.prototype.map?function(a,b){return Array.prototype.map.call(a,b,void 0)}:function(a,b){for(var c=a.length,d=Array(c),e="string"===typeof a?a.split(""):a,f=0;f<c;f++)f in e&&(d[f]=b.call(void 0,e[f],f,a));
...
function Ua(a,b){for(var c=1;c<arguments.length;c++){var d=arguments[c];if(Ba(d)){var e=a.length||0,f=d.length||0;a.length=e+f;for(var h=0;h<f;h++)a[e+h]=d[h]}else a.push(d)}}
...
function wc(a,b,c){var d=arguments,e=document,f=String(d[0]),h=d[1];if(!qc&&h&&(h.name||h.type)){f=["<",f];h.name&&f.push(' name="',Ob(h.name),'"');if(h.type){f.push(' type="',Ob(h.type),'"');var g={};fb(g,h);delete g.type;h=g}f.push(">");f=f.join("")}f=xc(e,f);h&&("string"===typeof h?f.className=h:Array.isArray(h)?f.className=h.join(" "):uc(f,h));2<d.length&&yc(e,f,d);return f}
...
function Lc(a){for(var b=0,c=arguments.length;b<c;++b){var d=arguments[b];Ba(d)?Lc.apply(null,d):Jc(d)}}
;/*
...
function b(p){for(var v=h,r=0;64>r;r+=4)v[r/4]=p[r]<<24|p[r+1]<<16|p[r+2]<<8|p[r+3];for(r=16;80>r;r++)p=v[r-3]^v[r-8]^v[r-14]^v[r-16],v[r]=(p<<1|p>>>31)&4294967295;p=e[0];var B=e[1],K=e[2],na=e[3],Kc=e[4];for(r=0;80>r;r++){if(40>r)if(20>r){var Ia=na^B&(K^na);var Jb=1518500249}else Ia=B^K^na,Jb=1859775393;else 60>r?(Ia=B&K|na&(B|K),Jb=2400959708):(Ia=B^K^na,Jb=3395469782);Ia=((p<<5|p>>>27)&4294967295)+Ia+Kc+Jb+v[r]&4294967295;Kc=na;na=K;K=(B<<30|B>>>2)&4294967295;B=p;p=Ia}e[0]=e[0]+p&4294967295;e[1]=
e[1]+B&4294967295;e[2]=e[2]+K&4294967295;e[3]=e[3]+na&4294967295;e[4]=e[4]+Kc&4294967295}
...
var Yc;
function Zc(){var a=x.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&!H("Presto")&&(a=function(){var e=xc(document,"IFRAME");e.style.display="none";e.src=ob(new lb(mb,jb())).toString();document.documentElement.appendChild(e);var f=e.contentWindow;e=f.document;e.open();e.write(Ib(Lb));e.close();var h="callImmediate"+Math.random(),g="file:"==f.location.protocol?"*":f.location.protocol+"//"+f.location.host;e=A(function(k){if(("*"==g||
...
;function ye(a){a=a.split("&");for(var b={},c=0,d=a.length;c<d;c++){var e=a[c].split("=");if(1==e.length&&e[0]||2==e.length)try{var f=decodeURIComponent((e[0]||"").replace(/\+/g," ")),h=decodeURIComponent((e[1]||"").replace(/\+/g," "));f in b?Aa(b[f])?Ua(b[f],h):b[f]=[b[f],h]:b[f]=h}catch(k){if("q"!=e[0]){var g=Error("Error decoding URL component");g.params={key:e[0],value:e[1]};te(g)}}}return b}
function ze(a){var b=[];Wa(a,function(c,d){var e=encodeURIComponent(String(d)),f;Aa(c)?f=c:f=[c];F(f,function(h){""==h?b.push(e):b.push(e+"="+encodeURIComponent(String(h)))})});
return b.join("&")}
...
return d}
function $e(a){if(Da(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d=Kb(a[b],null);a[c]=d}else $e(a[b])}}
...
return b}
function We(a,b,c,d,e,f,h){function g(){4==(k&&"readyState"in k?k.readyState:0)&&b&&se(b)(k)}
...
try{kf[a]?f():S(f,0)}catch(h){te(h)}},void 0);
...
function Ef(){T(zf);T(Af);Af=0;if(!$a(V)){for(var a in V){var b=yf[a];if(b&&b.isReady()){var c=void 0,d=a,e=wf[d],f=Math.round(U());for(c in V[d]){var h=db,g=b.f||Ff();g={client:{hl:g.Ia,gl:g.Ha,clientName:g.Ga,clientVersion:g.innertubeContextClientVersion,configInfo:g.Fa}};var k=window.devicePixelRatio;k&&1!=k&&(g.client.screenDensityFloat=String(k));k=Q("EXPERIMENTS_TOKEN","");""!==k&&(g.client.experimentsToken=k);var l=k=void 0,m=[],p=Q("EXPERIMENTS_FORCED_FLAGS",{});for(l in p)m.push({key:l,value:String(p[l])});
...
(g.previousBatchInfo={serializedClientEventId:uf,roundtripMs:vf}),uf=k,vf=0;If(b,d,h,{retry:xf.has(d),onSuccess:Ka(Jf,U())})}delete V[a];Cf=!1}}$a(V)||Kf()}}
...
Nf.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var Za=z("ytEventsEventsListeners")||{};y("ytEventsEventsListeners",Za,void 0);var Pf=z("ytEventsEventsCounter")||{count:0};y("ytEventsEventsCounter",Pf,void 0);
function Qf(a,b,c,d){d=void 0===d?{}:d;a.addEventListener&&("mouseenter"!=b||"onmouseenter"in document?"mouseleave"!=b||"onmouseenter"in document?"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"):b="mouseout":b="mouseover");return Ya(function(e){var f="boolean"===typeof e[4]&&e[4]==!!d,h=Da(e[4])&&Da(d)&&bb(e[4],d);return!!e.length&&e[0]==a&&e[1]==b&&e[2]==c&&(f||h)})}
var Rf=Va(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
...
h=se(h);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),Rf()||"boolean"===typeof d?a.addEventListener(b,h,d):a.addEventListener(b,h,!!d.capture)):a.attachEvent("on"+b,h);Za[e]=[a,b,c,h,d];return e}
function Sf(a){a&&("string"==typeof a&&(a=[a]),F(a,function(b){if(b in Za){var c=Za[b],d=c[0],e=c[1],f=c[3];c=c[4];d.removeEventListener?Rf()||"boolean"===typeof c?d.removeEventListener(e,f,c):d.removeEventListener(e,f,!!c.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete Za[b]}}))}
...
function eg(a,b,c,d){d=void 0===d?{}:d;var e={};e.eventTimeMs=Math.round(d.timestamp||U());e[a]=b;e.context={lastActivityMs:String(d.timestamp?-1:cg())};R("log_sequence_info_on_gel_web")&&d.P&&(a=e.context,b=d.P,dg[b]=b in dg?dg[b]+1:0,a.sequence={index:dg[b],groupKey:b},d.rb&&delete dg[d.P]);(d=d.da)?(a={},d.videoId?a.videoId=d.videoId:d.playlistId&&(a.playlistId=d.playlistId),Df[d.token]=a,d=Hf("log_event",d.token)):d=Hf("log_event");d.push(e);c&&(yf.log_event=new c);c=Ie("web_logging_max_batch")||
...
function gg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||Q("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.ob||Q("AUTHORIZATION"))||(a?b="Bearer "+z("gapi.auth.getToken")().nb:b=Sc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=Q("SESSION_INDEX",0),R("pageid_as_header_web")&&(d["X-Goog-PageId"]=Q("DELEGATED_SESSION_ID")));return d}
...
function ng(a){var b=kg.get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(U())-d.requestTime)){var e=d.authState,f=hg(gg(!1));bb(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(U())),If(a,d.method,e,{}));delete b[c]}}kg.set("requests",b,86400,!0)}}
...
function If(a,b,c,d){!Q("VISITOR_DATA")&&"visitor_id"!==b&&.01>Math.random()&&ue(Error("Missing VISITOR_DATA when sending innertube request."));var e={headers:{"Content-Type":"application/json"},method:"POST",C:c,ra:"JSON",O:function(){d.O()},
...
c.oa=function(v,r){mg(l);p(v,r)}}try{R("use_fetch_for_op_xhr")?Se(k,e):(e.method="POST",e.C||(e.C={}),Ve(k,e))}catch(v){if("InvalidAccessError"==v)l&&(mg(l),l=0),ue(Error("An extension is blocking network request."));
...
function Hg(a){var b=document.createElement("a");Mb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+Pb(a)}
var Ig={};var Mg=[],Ng=!1;function Og(){if("1"!=Xa(oe(),"args","privembed")){var a=function(){Ng=!0;"google_ad_status"in window?P("DCLKSTAT",1):P("DCLKSTAT",2)};
...
y("yt_logging_screen.setCurrentScreen",nh,void 0);function oh(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=Q("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=Q("VALID_SESSION_TEMPDATA_DOMAINS",[]),h=I(J(3,window.location.href));h&&f.push(h);h=I(J(3,d));if(0<=Na(f,h)||!h&&0==d.lastIndexOf("/",0))if(R("autoescape_tempdata_url")&&(f=document.createElement("a"),Mb(f,d),d=f.href),d){h=d.match(Qb);d=h[5];f=h[6];h=h[7];var g="";d&&(g+=d);f&&(g+="?"+f);h&&(g+="#"+h);d=g;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||
b.ved)&&(b=Object.assign({csn:kh()},b)),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e=b,b="ST-"+Pb(d).toString(36),e=e?Sb(e):"",ig(b,e,k||5))}else k=b,e="ST-"+Pb(d).toString(36),k=k?Sb(k):"",ig(e,k,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var m=void 0===m?"":m;var p=void 0===p?window:p;c=p.location;a=Tb(a,l)+m;a=a instanceof G?a:Cb(a);c.href=Ab(a)}return!0}
...
Ta(k.args))}catch(p){throw p.message="yt.pubsub2.Data.deserialize(): "+p.message,p;}}catch(p){throw p.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+p.message,p;}a.call(window,f)}catch(p){te(p)}},uh[b.toString()]?z("yt.scheduler.instance")?Wf(h):S(h,0):h())});
...
t(Ch,ph);var yh=new qh("screen-created",Ch),Dh=[],Eh=0;function Fh(a,b,c){var d=R("use_default_events_client")?void 0:og;b={csn:a,parentVe:eh(b),childVes:Pa(c,function(f){return eh(f)})};
c=q(c);for(var e=c.next();!e.done;e=c.next())e=eh(e.value),($a(e)||!e.trackingParams&&!e.veType)&&wg(Error("Child VE logged with no data"),"WARNING");c={da:mh(a),P:a};"UNDEFINED_CSN"==a?Gh("visualElementAttached",b,c):d?eg("visualElementAttached",b,d,c):pg("visualElementAttached",b,c)}
...
;function Hh(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||cb(b);this.assets=a.assets||{};this.attrs=a.attrs||cb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
Hh.prototype.clone=function(){var a=new Hh,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==za(c)?a[b]=cb(c):a[b]=c}return a};function Ih(){M.call(this);this.f=[]}
t(Ih,M);Ih.prototype.o=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.pb)}M.prototype.o.call(this)};var Jh=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Kh(a){a=a||"";if(window.spf){var b=a.match(Jh);spf.style.load(a,b?b[1]:"",void 0)}else Lh(a)}
...
function Mh(a){var b=xc(document,"A");Mb(b,new G(yb,a));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Pb(a)}
...
function ai(a,b,c){var d=b[c];return function(){try{return a.ba=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.params=c,a.ba=e,ue(e))}}}
...
n.Z=function(a,b){var c=this,d=Sh(this,b);if(d){if(!(0<=Na(this.ua,a)||this.j[a])){var e=bi(this,a);this.D&&this.D(a,e)}this.F.subscribe(a,d);"onReady"==a&&this.w&&S(function(){d(c.api)},0)}};
...
n.o=function(){Yh(this);if(this.l&&this.f&&this.l.destroy)try{this.l.destroy()}catch(b){te(b)}this.Y=null;for(var a in this.j)x[this.j[a]]=null;this.ca=this.f=this.api=null;delete this.X;delete this.m;M.prototype.o.call(this)};
...
t(aj,M);aj.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.w)}catch(e){ue(e)}}};
...
fj.prototype.o=function(){Sf(this.j);this.f=null;M.prototype.o.call(this)};function gj(){var a=cb(hj),b;return Ld(new N(function(c,d){a.onSuccess=function(e){Le(e)?c(e):d(new ij("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
t(nj,E);nj.prototype.name="BiscottiMissingError";var hj={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},oj=null;function we(){if("1"===Xa(oe(),"args","privembed"))return Jd(Error("Biscotti ID is not available in private embed mode"));oj||(oj=Ld(gj().then(pj),function(a){return qj(2,a)}));
return oj}
function pj(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new nj;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new nj;a=a.id;xe(a);oj=kj(a);rj(18E5,2);return a}
function qj(a,b){var c=new mj(b);xe("");oj=lj(c);0<a&&rj(12E4,a-1);throw c;}
function rj(a,b){S(function(){Ld(gj().then(pj,function(c){return qj(b,c)}),xa)},a)}
function sj(){try{var a=z("yt.ads.biscotti.getId_");return a?a():we()}catch(b){return Jd(b)}}
;function tj(a){if("1"!==Xa(oe(),"args","privembed")){a&&ve();try{sj().then(function(){},function(){}),S(tj,18E5)}catch(b){te(b)}}}
